...
{
2\NT && 5 cartes à \C et arrêt \k\\
3\T  && 5 cartes à \C, pas d'arrêt \K\\
3\K  && 6 cartes à \C et arrêt \K \\
->  & 3\P & transfert pour 3\NT \\
3\C && 6 cartes à \C, pas d'arrêt \K \\
3\P && 3631 pas d'arrêt \K
\\4\T && 6 cartes à \P singleton \T \\
...
\section{Soutien de l'ouvreur}


\enchbox{1\C--2\T--3\T}
{
3\C && impose l'atout \\
-> & 3\P  & contrôle \P et singleton \K \\
-> & 3\NT & singleton sans contrôle \\
-> & 4\T  & 5422 14-16H \\
-> & 4\K  & contrôle \K singleton \P \\
-> & 4\C  & 5422 11-13H \\
}
4\T && 6 cartes à \P et singleton \T \\
\enchbox{1\C--2\T--3\T--3\C--3\NT}
{
4\T && relai \\
-> & 4\K & singleton \K \\(2C|2D)--(2D|2H
-> & 4\C & singleton \P \\
}
...
{
3\C && impose l'atout \\
-> & 3\P  & contrôle \P et singleton \T \\
-> & 3\NT & singleton sans contrôle \\
-> & 4\T  & contrôle \T singleton \P \\
-> & 4\K  & 5422 14-16H \\
-> & 4\C  & 5422 11-13H \\4\T && 6 cartes à \P et singleton \T \\
}

\enchbox{1\C--2\K--3\K--3\C--3\NT}
{
4\T && relai \\
-> & 4\K & singleton \T \\
-> & 4\C & singleton \P \\
...
-> & 3\NT & singleton sans contrôle \\
-> & 4\T  & 5422 14-16H \\
-> & 4\K  & contrôle \K singleton \C \\
-> & 4\C  & contrôle \C singleton \K \\
-> & 4\P  & 5422 11-13H \\
}

\enchbox{1\P--2\T--3\T--3\P--3\NT}
{
4\T && relai \\
-> & 4\K & singleton \K \\
-> & 4\C & singleton \C \\
...
-> & 3\NT & singleton sans contrôle \\
-> & 4\K  & 5422 14-16H \\
-> & 4\T  & contrôle \T singleton \C \\
-> & 4\C  & contrôle \C singleton \T \\
-> & 4\P  & 5422 11-13H \\
}

\enchbox{1\P--2\K--3\K--3\P--3\NT}
{
4\T && relai \\
-> & 4\K & singleton \T\\
-> & 4\C & singleton \C \\
...
%_1S--2[CDH]--2[DHS]--, 3H, 18DH couleur secondaire 5\ième
%_1S--2[CDH]--2[DHS]--, 4[CD], splinter
%_1H--2[CD]--2[DH]--, 3H, 18DH couleur secondaire 5\ième
%_1H--2[CD]--2[DH])--, 4[CD], splinter
